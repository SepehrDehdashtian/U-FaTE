...
class PrepareCelebA:
    ...
    def load_data(self):
        ...
        # data['train'] = {'imgs': images[:200],          'y': y[:200],         's': s[:200]}
        # data['val']   = {'imgs': images[200:300],    'y': y[200:300],   's': s[200:300]}
        # data['test']  = {'imgs': images[300:400],          'y': y[300:400],         's': s[300:400]}
...
class CelebAImageLoader(pl.LightningDataModule):
    def __init__(self, opts):
        super().__init__()
        self.opts = opts
        if opts.ngpu == 0:
